...
public:
	...
	bool
	operator()(size_t i1, size_t i2) const
	{
...
public:
	...
	testSortDistance0()
	{
		...
		++iter;
		TS_ASSERT(iter->second == 6);
		++iter;
		TS_ASSERT(iter->second == 7);
		++iter;
		TS_ASSERT(iter->second == 1);
		++iter;
		TS_ASSERT(iter->second == 2);
		++iter;
		TS_ASSERT(iter->second == 3);
		++iter;
		TS_ASSERT(iter->second == 4);
		++iter;
