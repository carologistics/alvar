...
public:
	...
	testUtils_allocateXMLMatrix()
	{
		...
		if (!document.LoadFile(path + "/test_matrix.xml"))
			return;
	...
	testUtils_parseXMLMatrix()
	{
		...
		TS_ASSERT(
		  !FileFormatUtils::parseXMLMatrix(xml_root->FirstChildElement("matrix_error1"), mat_2));
		TS_ASSERT(
		  !FileFormatUtils::parseXMLMatrix(xml_root->FirstChildElement("matrix_error2"), mat_2));
		TS_ASSERT(
		  !FileFormatUtils::parseXMLMatrix(xml_root->FirstChildElement("matrix_error3"), mat_2));
		TS_ASSERT(
		  !FileFormatUtils::parseXMLMatrix(xml_root->FirstChildElement("matrix_error4"), mat_2));
	...
	testUtils_createXMLMatrix()
	{
		...
		TS_ASSERT(xml_1);
		{
			...
			const char str[] = "<matrix_1 type=\"CV_32F\" rows=\"3\" "
			                   "cols=\"4\"><data>1.1</data><data>1.2</data><data>1.3</data><data>1.4</"
			                   "data><data>2.0999999</data><data>2.2</data><data>2.3</"
			                   "data><data>2.4000001</data><data>3.0999999</data><data>3.2</"
			                   "data><data>3.3</data><data>3.4000001</data></matrix_1>";
...
#ifdef WIN32
			const char str[] =
			  "<matrix_2 type=\"CV_64F\" rows=\"4\" "
			  "cols=\"3\"><data>2.3149871892740001e-005</data><data>494.19838264911749</data><data>1.3</"
			  "data><data>2.1000000000000001</data><data>2.2000000000000002</"
			  "data><data>2.2999999999999998</data><data>3.1000000000000001</"
			  "data><data>3.2000000000000002</data><data>3.2999999999999998</"
			  "data><data>4.0999999999999996</data><data>4.2000000000000002</"
			  "data><data>4.2999999999999998</data></matrix_2>";
#else
			const char str[] =
			  "<matrix_2 type=\"CV_64F\" rows=\"4\" "
			  "cols=\"3\"><data>2.3149871892740001e-05</data><data>494.19838264911749</data><data>1.3</"
			  "data><data>2.1000000000000001</data><data>2.2000000000000002</"
			  "data><data>2.2999999999999998</data><data>3.1000000000000001</"
			  "data><data>3.2000000000000002</data><data>3.2999999999999998</"
			  "data><data>4.0999999999999996</data><data>4.2000000000000002</"
