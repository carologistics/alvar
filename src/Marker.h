...
{
protected:
    void VisualizeMarkerPose(cv::Mat&image, Camera *cam, double visualize2d_points[12][2], CvScalar color = cvScalar(CV_RGB(255,0,0))) const;
...
public:
	 ...
	 */
    void Visualize(cv::Mat&image, Camera *cam, CvScalar color=cvScalar(CV_RGB(255,0,0))) const;
