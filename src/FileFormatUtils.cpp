...
bool
FileFormatUtils::decodeXMLMatrix(const TiXmlElement *xml_matrix, int &type, int &rows, int &cols)
{
...
cv::Mat *
FileFormatUtils::allocateXMLMatrix(const TiXmlElement *xml_matrix)
{
	if (!xml_matrix)
		return NULL;
...
bool
FileFormatUtils::parseXMLMatrix(const TiXmlElement *xml_matrix, cv::Mat &matrix)
{
...
TiXmlElement *
FileFormatUtils::createXMLMatrix(const char *element_name, const cv::Mat &matrix)
{
	if (matrix.empty())
		return NULL;
