...
bool
CapturePtgrey::showSettingsDialog()
{
	return false;
}

string
CapturePtgrey::SerializeId()
{
	return "CapturePtgrey";
}

bool
CapturePtgrey::Serialize(Serialization *serialization)
{
	return false;
}

CapturePluginPtgrey::CapturePluginPtgrey(const string &captureType) : CapturePlugin(captureType)
{
}
...
CapturePluginPtgrey::enumerateDevices()
{
...
Capture *
CapturePluginPtgrey::createCapture(const CaptureDevice captureDevice)
{
