...
bool
CaptureHighgui::showSettingsDialog()
{
...
std::string
CaptureHighgui::SerializeId()
{
	return "CaptureHighgui";
}

bool
CaptureHighgui::Serialize(Serialization *serialization)
{
	return false;
}
...
CapturePluginHighgui::enumerateDevices()
{
...
Capture *
CapturePluginHighgui::createCapture(const CaptureDevice captureDevice)
{
