...
void
CaptureFactoryPrivate::setupPluginPaths()
{
...
void
CaptureFactoryPrivate::parseEnvironmentVariable(const std::string &variable)
{
...
std::string
CaptureFactoryPrivate::pluginPrefix()
{
	return std::string("lib");
}

std::string
CaptureFactoryPrivate::pluginExtension()
{
