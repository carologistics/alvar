...
int
RansacImpl::_estimate(void *params, int param_c, int support_limit, int max_rounds, void *model)
{
...
int
RansacImpl::_refine(void *params,
                    int   param_c,
                    int   support_limit,
                    int   max_rounds,
                    void *model,
...
int
RansacImpl::_estimate(int param_c, int support_limit, int max_rounds, void *model)
{
	if (param_c < min_params)
		return 0;
...
int
RansacImpl::_refine(int param_c, int support_limit, int max_rounds, void *model, char *inlier_mask)
{
	if (param_c < min_params)
		return 0;
...
int
RansacImpl::estimateRequiredRounds(float success_propability, float inlier_percentage)
{
