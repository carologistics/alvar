...
main(int argc, char *argv[])
{
	try {
		...
		std::cout << "  This is an example of how to use the 'LabelingCvSeq' class to perform"
		          << std::endl;
		std::cout << "  labeling. Blobs are detected in the image and if the blobs have four"
		          << std::endl;
